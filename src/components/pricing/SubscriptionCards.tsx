  ...
  const plans: SubscriptionPlan[] = [
    {
      ...
      period: "forever",
      features: [
        "Generate 5 quizzes from PDFs per month (Teachers only)",
        "Basic PDF processing",
        "Standard question types",
        "Community support",
        "Up to 10 questions per quiz",
        "Access to over 100 Past Questions",
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "Export quizzes (PDF, DOCX, Google Forms)",
        "Access to full Past Question library",
